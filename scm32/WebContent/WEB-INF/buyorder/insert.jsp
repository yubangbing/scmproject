				...
				.datagrid(
						{
							...
							onClickCell : function(index, field, value) {
								if (editIndex != undefined) {
									...
									var buyPrice = $(this).datagrid(
											'getEditor', {
												index : editIndex,
												field : "bodBuyPrice"
											});
									var bodTotalPrice = $(buyPrice.target)
											.numberbox('getValue')
											* $(amount.target).numberbox(
													'getValue');
...
<body class="mybody">
	<form class="myfm"
		style="padding: 15px; margin: 0px; background: #eee;" id="ff"
		action="">
		<div class="myftitle">请填写采购信息</div>
		<div class="myfitem2">
			<label>供应商：</label><input type="hidden" id="supId" name="supId" /> <input
				type="text" id="supName" name="supName" /> <label>仓库：</label><select
				id="cc" class="easyui-combobox" name="shId" style="width: 200px;">
